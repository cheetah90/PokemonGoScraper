...
def parse_map(map_dict, cellid_lock, remaining_cells):
    pokemons = {}
    pokestops = {}
    gyms = {}
    ...
    for cell in cells:
        ...
        # remove this cell id from the remaining cells list
        with cellid_lock:
            if cell['s2_cell_id'] in remaining_cells:
                remaining_cells.remove(cell['s2_cell_id'])

    log.info("Scanned {} cells, {} remaining.".format(len(cells), len(remaining_cells)))
